...
const Header = () => {
    ...
    return (
        <>
            <header>
                <h1 className=""><img className='is-centered' src={isAdmin == 1 ? ("/assets/icon-left-font.svg") : ("/assets/icon-left-font-monochrome-white.svg")} width="200" alt="Groupomania" /></h1>
